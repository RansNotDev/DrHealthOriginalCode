...
<head>
    ...
    <style>
        ...
        .form-container {
    margin-top: 1000px; /* Adjusted to lower the position further */
    ...
    console.log("Sending OTP and saving user data.");
...
<div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="input-group">
            ...
            <div class="input-group-append">
                <button class="btn btn-outline-secondary" type="button" onclick="togglePasswordVisibility('cpassword', 'toggleIconConfirm')">
                    <i id="toggleIconConfirm" class="fa fa-eye"></i>
                </button>
            </div>
        </div>
        <div id="message" class="form-text mt-1"></div> <!-- Message for password match with icon -->
    </div>
